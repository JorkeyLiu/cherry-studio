...
const ChatNavigation: FC<ChatNavigationProps> = ({
  ...
  const handleScrollToTop = () => {
    ...
    // Two-stage "top" behavior:
    //   First click  → scroll to context boundary (via transaction)
    //   Second click → scroll to topic oldest (via transaction)
    if (!stoppedAtBoundaryRef.current && scrollToContextBoundary) {
