 ...
 * measurement scope closed; evidence L1/L3 semantics per docs/archived/performance-measurement.md §2,
 ...
 *     until re-measured per docs/archived/performance-measurement.md §7.
 *
