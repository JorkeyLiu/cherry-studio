...
> **Historical notice — superseded.** This document is a **historical record** of the Cherry Chat first-phase synchronization boundary proposal as of 2026-08-19. Its **Phase 0/1 proposal framing and open-question stance are superseded**. Current sync status is owned by [`../work/multi-device-sync.md`](../work/multi-device-sync.md); candidate analysis is preserved as fallback reference in [`sync-architecture-selection.md`](sync-architecture-selection.md). Do not use this file as an active design input.
...
> **Related governance**: SQLite chat authority by [SQLite migration governance](sqlite-migration.md); identity/platform/release by [Application Identity ADR](../adr/cherry-chat-application-identity.md); context-window anchor by [Context window governance](../adr/context-window.md); program-level S8 by [Architecture Evolution Program](architecture-evolution-program.md) Phase 8.
...
- **For all new sync work**: read [`../work/multi-device-sync.md`](../work/multi-device-sync.md) first. Candidate analysis in [`sync-architecture-selection.md`](sync-architecture-selection.md) is a conditional fallback reference only.
...
*End of historical record — for superseded Phase 0/1 proposal; current reference is `../work/multi-device-sync.md`.*
