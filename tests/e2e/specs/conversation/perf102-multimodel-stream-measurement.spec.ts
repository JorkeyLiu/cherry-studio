 ...
 *
 * Purpose (docs/archived/performance-workstreams.md §2.2, PERF-STREAMING measurement slice):
 ...
 *   threshold, no root-cause attribution (PERF-LOCK-004/005/007, docs/archived/performance-workstreams.md §4).
 *
 ...
 * the test and produces NO artifact, audit F1-style gate, docs/archived/performance-measurement.md §3). The per-sample
 ...
 *     re-measured per docs/archived/performance-measurement.md §7. No thresholds are asserted.
 *
