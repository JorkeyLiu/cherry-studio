...
- [ ] Self-review: I have reviewed my own code (e.g., via [`/github-workflow`](/.claude/skills/github-workflow/SKILL.md), `gh pr diff`, or GitHub UI) before requesting review from others
