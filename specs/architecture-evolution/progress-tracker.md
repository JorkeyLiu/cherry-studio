...
- **Phase 6 DB-Health — `S6.1..S6.3` Authorized & Implemented; `S6.4 SQ-01 Rejected 2026-08-29; M2/M3 batch closed; M1 9 combos 45 metrics 3/3 gates, B-01..B-05 calibration 25 metrics 7/7 gates, M8 21/21 gates 15 metrics, M5/M6 small-profile directional L3, all synthetic isolated, directional-only, future inactive; C-01/C-02/stream-persist directional evidence summarized under Phase 4 and §7.3; S6.5 Candidate — Not Authorized.** See program §6.7.1/§7.1–§7.3 for decision and future reopening boundary; no threshold/baseline/phase-closure or sync-schema/runtime-consistency claim.
...
- `S6.5` file dual-state / FTS dedup — **Candidate — Not Authorized**, each needs slice evidence plus ADR/governance; M4/M5, M1, B-01..B-05, M8 directional L3 evidence summarized in Phase 6 frontier and program §7.1–§7.3 (synthetic isolated, directional-only, future inactive); C-02 heap diagnostic benchmark chatdb-c02-renderer-heap-e2e uniform 23/12 mixed 48/9 all 48/9, synthetic isolated, directional measurement-only, no threshold/baseline/SLA/capacity/policy/closure; none authorize production inference. Real-corpus/physical-size remains unresolved; any S6.5 work still requires explicit activation, decision, privacy review where applicable, and ADR; no S6.5 authorization, no threshold/baseline/phase-closure, no runtime-consistency or sync-design claim; B-01..B-05 calibration optional/non-blocking, M1 independent diagnostic, M8 synthetic archive/restore health only.
