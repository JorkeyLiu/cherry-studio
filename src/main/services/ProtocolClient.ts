...
export const APP_PROTOCOL = appIdentity.protocolScheme
...
export function handleProtocolUrl(url: string) {
  ...
  // The url will be in the format: ${APP_PROTOCOL}://data?param1=value1&param2=value2
...
const DESKTOP_FILE_NAME = `${appIdentity.protocolScheme}-url-handler.desktop`

/**
 * Sets up deep linking for the AppImage build on Linux by creating a .desktop file.
 * This allows the OS to open <protocol>:// URLs with this App.
 */
...
Name=${appIdentity.protocolDisplayName}
