...
**Current M4 frontier:** All bounded synthetic profiles (1k, 10k, and 50k) are complete as measurement-only directional evidence. Real-corpus evidence and physical database-size evidence remain unresolved; M5 remains unexecuted and unactivated, with no M5 harness. Any further M4 real-corpus or physical-size diagnostic, and any M5 diagnostic activation, require an explicit decision, privacy review where applicable, and applicable governance/ADR. No production batch is Ready now; S6.5 remains **Candidate — Not Authorized**.
