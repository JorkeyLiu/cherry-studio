 ...
 * `string | null` and is deliberately decoupled from persisted override state —
 * automatic/default derivation, user override, override deletion, and deletion
 * transfer all resolve to this same projected key.
 *
