...
export type {
  ...
  FetchClipboardGroupsGroup,
  FetchClipboardGroupsMeta,
  ...
  ResolveContextClosureDetail,
  ResolveContextClosureIntent,
  ResolveContextClosureMeta,
