...
export async function registerIpc(mainWindow: BrowserWindow, app: Electron.App) {
  ...
  ipcMain.handle(IpcChannel.File_Base64ImageExternal, fileManager.base64ImageExternal.bind(fileManager))
  ...
  ipcMain.handle(IpcChannel.File_GetPdfInfoExternal, fileManager.pdfPageCountExternal.bind(fileManager))
  ipcMain.handle(IpcChannel.File_GetImageSize, fileManager.imageSize.bind(fileManager))
  ipcMain.handle(IpcChannel.File_GetImageSizeExternal, fileManager.imageSizeExternal.bind(fileManager))
