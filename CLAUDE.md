...
All development occurs on the `main` branch. Use `hotfix/*` branches for critical bug fixes only.
...
- **Currently undergoing refactoring** — accepts bug fixes
...
> **Note**: Redux state shape changes should be carefully considered for backward compatibility.
