 ...
 *
 * Purpose (docs/archived/performance-workstreams.md §2.1, PERF-TOPIC-SWITCH measurement slice +
 ...
 *   topic-switch cost model (docs/archived/performance-workstreams.md §2.1)) — against a FRESH production build via the standard shared E2E
 ...
 *   (PERF-LOCK-004/005/007, docs/archived/performance-workstreams.md §4).
 *
 ...
 *   (docs/archived/performance-measurement.md §5).
 *
 ...
 *     re-measured per docs/archived/performance-measurement.md §7. No thresholds are asserted (the only committed
 *     threshold remains the cold-open <500ms gate; PERF-101 has none,
 *     PERF-LOCK-005 / docs/archived/performance-measurement.md §7).
 *
 ...
 *     F1-style gate, docs/archived/performance-measurement.md §3).
